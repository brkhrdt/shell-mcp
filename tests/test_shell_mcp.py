...
async def test_start_and_close_shell_session():
    ...
    result = await start_shell_session(["bash", "--norc", "-i"], prompt_patterns=[r'bash.*\$'])
...
async def test_start_shell_session_failure():
    ...
    result = await start_shell_session(["nonexistent_command_12345"], prompt_patterns=[r'bash.*\$'])
...
async def test_run_shell_command():
    ...
    # Start a bash session
    start_result = await start_shell_session(["bash", "--norc", "-i"], prompt_patterns=[r'bash.*\$'])
...
async def test_multiple_active_sessions():
    ...
    bash_result = await start_shell_session(["bash", "--norc", "-i"], prompt_patterns=[r'bash.*\$'])
...
async def test_close_all_sessions():
    ...
    # Start multiple sessions
    session1_result = await start_shell_session(["bash", "--norc", "-i"], prompt_patterns=[r'bash.*\$'])
